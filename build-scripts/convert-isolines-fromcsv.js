...
// create a readStream
let readableStream = fs.createReadStream('../project-files/eastpeak.csv')
...
.subscribe((jsonObj, i)=>{ // converts to json
...
.on('done',(error)=>{
    ...
    // write output file
    fs.writeFile('../data/east-peak.json', JSON.stringify(geojson), 'utf-8', (err) => {
